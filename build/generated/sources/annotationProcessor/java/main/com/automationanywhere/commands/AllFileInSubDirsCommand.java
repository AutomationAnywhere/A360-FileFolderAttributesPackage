...
public final class AllFileInSubDirsCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(AllFileInSubDirsCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    AllFileInSubDirs command = new AllFileInSubDirs();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("inputFolderPath")));
